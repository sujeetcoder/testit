...
export const getProducts = (page,orderBy,limit=10) => {
  return fetch(`https://dbioz2ek0e.execute-api.ap-south-1.amazonaws.com/mockapi/get-products?page=${page}&limit=${limit}&orderBy=${orderBy}`).then((res)=>{
    return res.json()
  }).then((res)=>res);
};
